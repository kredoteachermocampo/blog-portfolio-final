...
<body>
    ...
    <main class="container w-50 mx-auto">
        ...
        <div class="col-10 mx-auto ">
            <form method="post">
                <input type="text" name="title" class="form-control mb-3 border-3 border-info border-top-0 border-end-0 border-start-0 rounded-0" placeholder="TITLE" required autofocus>


                <input type="date" name="date_posted" class="form-control mb-3 border-3 border-dark border-top-0 border-end-0 border-start-0 rounded-0" required>
                ...
                <textarea name="message" class="form-control mb-3 border-3 border-dark" rows="7" placeholder="MESSAGE"></textarea>
                ...
                <div class="input-group">
                    ...
                    <select name="author_id" class= "form-select border-3 border-dark border-top-0 border-end-0 border-start-0 rounded-0">
                        ...
                        ?>
                                <option value="<?= $account_row['account_id'] ?>">
                ...
                <button type="submit" name="post" class="btn btn-dark w-100 my-5 text-uppercase">Post</button>
            </form>
        </div>
    </main>
</body>
